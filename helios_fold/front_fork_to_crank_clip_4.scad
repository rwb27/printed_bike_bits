...
difference(){
	union(){
		translate([socket_radius+clip_t+5,socket_radius+clip_t,base_z]) rotate(-70) cylinder_clip(r=socket_radius, t=clip_t,flat_w=1,flat_t=clip_t+5,h=clip_h,opening_angle=130);
